...
plot 'analysis/benchmark.csv' using 3:(stringcolumn(2) eq initialstate? (stringcolumn(1) eq "Heap Sort"? $4:1/0):1/0) title 'Heap Sort' with lines ls 1, \
     'analysis/benchmark.csv' using 3:(stringcolumn(2) eq initialstate? (stringcolumn(1) eq "Native Sort"? $4:1/0):1/0) title 'Native Sort' with lines ls 2, \
     'analysis/benchmark.csv' using 3:(stringcolumn(2) eq initialstate? (stringcolumn(1) eq "Quick Sort"? $4:1/0):1/0) title 'Quick Sort' with lines ls 3, \
